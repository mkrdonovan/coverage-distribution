...
if __name__ == "__main__":
	...
	# parser.add_argument('--chr', dest='chrToAnalyze', type=str, choices=['LONG', 'ALL', '*'], default='LONG', help='Choose to analyze largest chromosome ("LONG"), choose to analyze all chromosomes ("ALL"), or specify the chromosome name to analyze')
	...
	if args.downsample == False and args.plotHist == False:
		logger.info('Did not choose an action. Please select --generate-histograms or --replot-histograms.')
		exit()
